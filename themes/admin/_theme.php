...
<div class="offcanvas-header" style="background-color: black; color: white;">
    ...
    <?php
      if(!empty($_SESSION)){
    ?>
    <a class="btn btn-danger" href="<?= url("admin/sair") ?>" role="button">Sair</a>
    <?php
      }
    ?>
...
<div class="offcanvas-body">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a style="text-decoration: none; color: #3d29cf; margin-left: 20px;" href="<?= url("admin")?>">Home</a></li>
    <li class="breadcrumb-item"><a style="text-decoration: none; color: #3d29cf;" href="<?= url("produtos_main") ?>">Produtos</a></li>
    <li class="breadcrumb-item"><a style="text-decoration: none; color: #3d29cf;" href="<?= url("admin/produtoInsere") ?>">Inserir Produtos</a></li>
